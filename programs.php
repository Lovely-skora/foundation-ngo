...
<head>
    ...
    <!-- Page Title -->
    <title>Life Foundation || Our Programs</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-3" data-cursor="-opaque">Our Programs</h1>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6">
                    <div class="about-us-content">
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Creating Sustainable Impact Through Community-Centered Programs</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.2s">Life Foundation works across multiple sectors of social development with a commitment to empowering vulnerable communities and improving the quality of life of marginalized individuals. Through humanitarian initiatives, awareness programs, educational support, healthcare interventions, livelihood development, environmental action, child protection services, and community participation, the organization strives to create meaningful and sustainable social impact.</p>
                            <p>Our programs are designed to address the diverse social, economic, educational, healthcare, rehabilitation, and protection-related challenges faced by women, children, youth, rural populations, persons with disabilities, and economically disadvantaged communities.</p>
                            <p>Guided by compassion, inclusiveness, humanitarian values, and sustainable development principles, Life Foundation continuously works towards building stronger, healthier, safer, child-friendly, and more empowered communities.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-12">
                    <div>
                        ...
                        <p>Life Foundation is also actively engaged in child care, rehabilitation, protection, and adoption support services through its:</p>
                        <ul class="lh-lg">
                            <li>Child Care Institution (CCI)</li>
                            <li>Specialized Adoption Agency (SAA)</li>
                        </ul>
                        <p>which function in accordance with the Juvenile Justice (Care and Protection of Children) Act, 2015 and child welfare principles.</p>
                    </div>
                </div>
