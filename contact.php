...
<head>
  ...
  <!-- Page Title -->
  <title>Life Foundation || Contact</title>
            ...
            <div class="row section-row">
                <div class="col-lg-12">
                    ...
                    <div class="section-title section-title-center">
                        ...
                        <h2 class="text-anime-style-3" data-cursor="-opaque">Where We Make an Impact</h2>
                        <p class="wow fadeInUp" data-wow-delay="0.2s">Our offices and outreach centers are located across key regions, allowing us to connect directly with communities and deliver programs efficiently and effectively.</p>
                    </div>
                    <!-- Section Title End -->
                </div>
            </div>
